    ...
    <div class="container">
        <div class="row pt-5">
            ...
            <div class="col-12 col-lg-6 col-xl-4">
                <h1 class="text-center">Edit Pen Record</h1>
                <form method="post" action="<?php echo URLROOT; ?>/Pages/edit_pen/<?= $data['id']; ?>">
                    <div class="form-group mb-3">
                        <label for="pen-brand">Pen Brand</label>
                        <select class="form-control" type="text" name="pen-brand" id="pen-brand">
                            <option value="">--Select--</option>
                            <option value="Aurora" <?php if (isset($data['pen_brand']) && $data['pen_brand'] == "Aurora") echo "selected"; ?>>
                                Aurora
                            </option>
                            <option value="Caran d Ache" <?php if (isset($data['pen_brand']) && $data['pen_brand'] == "Caran d Ache") echo "selected"; ?>>
                                Caran d Ache
                            </option>
                            <option value="Cross" <?php if (isset($data['pen_brand']) && $data['pen_brand'] == "Cross") echo "selected"; ?>>
                                Cross
                            </option>
                            <option value="Aurora" <?php if (isset($data['pen_brand']) && $data['pen_brand'] == "Aurora") echo "selected"; ?>>
                                Aurora
                            </option>
                            <option value="Faber Castell" <?php if (isset($data['pen_brand']) && $data['pen_brand'] == "Faber Castell") echo "selected"; ?>>
                                Faber Castell
                            </option>
                            <option value="Ferris Wheel Press" <?php if (isset($data['pen_brand']) && $data['pen_brand'] == "Ferris Wheel Press") echo "selected"; ?>>
                                Ferris Wheel Press
                            </option>
                            <option value="Kaweco" <?php if (isset($data['pen_brand']) && $data['pen_brand'] == "Kaweco") echo "selected"; ?>>
                                Kaweco
                            </option>
                            <option value="Lamy" <?php if (isset($data['pen_brand']) && $data['pen_brand'] == "Lamy") echo "selected"; ?>>
                                Lamy
                            </option>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control" type="text" name="pen-name" id="pen-name"
                               value="<?= $data['pen_name'] ?>"/>
                    </div>

                    <div class="form-group mb-3">
                        <label for="pen-color">Pen Color</label>
                        <input class="form-control" type="text" name="pen-color" id="pen-color"
                               value="<?= $data['pen_color'] ?>"/>
                    </div>
                    <div class="form-group mb-3">
                        <label for="nib">Nib</label>
                        <select class="form-control" type="text" name="nib" id="nib" value="">
                            <option value="">--Select--</option>
                            <option value="Fine" <?php if (isset($data['nib']) && $data['nib'] == "Fine") echo "selected"; ?>>
                                Fine
                            </option>
                            <option value="Medium" <?php if (isset($data['nib']) && $data['nib'] == "Medium") echo "selected"; ?>>
                                Medium
                            </option>
                            <option value="Broad" <?php if (isset($data['nib']) && $data['nib'] == "Broad") echo "selected"; ?>>
                                Broad
                            </option>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control" type="text" name="filling-mech" id="filling-mech"
                               value="<?= $data['filling_mech'] ?>">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control" type="text" name="ink-brand" id="ink-brand">
                            <option value="">--Select--</option>
                            <option value="Aurora" <?php if (isset($data['ink_brand']) && $data['ink_brand'] == "Aurora") echo "selected"; ?>>
                                Aurora
                            </option>
                            <option value="Bungubox" <?php if (isset($data['ink_brand']) && $data['ink_brand'] == "Bungubox") echo "selected"; ?>>
                                Bungubox
                            </option>
                            <option value="Caran d'Ache" <?php if (isset($data['ink_brand']) && $data['ink_brand'] == "Caran d'Ache") echo "selected"; ?>>
                                Caran d'Ache
                            </option>
                            <option value="Colorverse" <?php if (isset($data['ink_brand']) && $data['ink_brand'] == "Colorverse") echo "selected"; ?>>
                                Colorverse
                            </option>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control" type="text" name="ink-color" id="ink-color"
                               value="<?= $data['ink_color'] ?>"/>
                    </div>
                    <div class="form-group mb-3">
                        <label for="date-filled">Date ink was loaded</label>
                        <input class="form-control" type="date" name="date-filled" id="date-filled"
                               value="<?= $data['date_filled'] ?>"/>
                    </div>
